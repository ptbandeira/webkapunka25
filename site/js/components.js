        ...
        <div class="container">
          ...
          <div class="offcanvas offcanvas-end" tabindex="-1" id="bdNavbar" aria-labelledby="bdNavbarOffcanvasLabel">
            ...
            <div class="offcanvas-body">
              <ul id="navbar" class="navbar-nav w-100 d-lg-flex justify-content-between align-items-center">

                <ul class="list-unstyled d-lg-flex align-items-center gap-4 m-0 p-0 flex-grow-1">
                  <li class="nav-item">
                ...
                <ul class="list-unstyled d-lg-flex align-items-center gap-4 m-0 p-0 flex-grow-1 justify-content-end">
